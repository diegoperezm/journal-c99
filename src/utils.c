...
int dropdown_active_a = 0;
bool dropdown_edit_mode_a = false;

int dropdown_active_b = 0;
bool dropdown_edit_mode_b = false;

bool elmnt_today_message_edit_mode = false;
char elmnt_today_message_text[255] = "";
